...
type OverviewStatsWithUsersMock = OverviewStats & { users: { _id: string; name: string; families: {_id: string, name: string, memberCount: number, createdAt: string}[], countOfChildren: number, createdAt: Date }[]};

export default function AdminDashboardPreview() {
  const [overviewStats, setOverviewStats] = useState<null | OverviewStatsWithUsersMock>(
    null,
  );
  const [searchTerm, setSearchTerm] = useState("");
  const [filteredUsers, setFilteredUsers] = useState<OverviewStatsWithUsersMock["users"]>(overviewStats ? overviewStats.users : []);
  ...
  const overviewStatsCallback = useCallback(async () => {
    ...
    overviewStatsResponse.users = [{
      ...
      name: "Jerry Smith",
      families: [
        { _id: "f1", name: "Smith Family", memberCount: 4, createdAt: "2023-01-15" },
        { _id: "f2", name: "Johnson Family", memberCount: 3, createdAt: "2023-03-22" }
      ],
      countOfChildren: 5,
    ...
    },
    {
      ...
      name: "Bob Williams",
      families: [
        { _id: "f3", name: "Williams Family", memberCount: 5, createdAt: "2023-02-10" },
        { _id: "f9", name: "Davis Family", memberCount: 3, createdAt: "2023-03-15" }
      ],
      countOfChildren: 2,
    ...
    },
    {
      ...
      name: "Carol Brown",
      families: [
        { _id: "f4", name: "Brown Family", memberCount: 6, createdAt: "2023-04-05" }
      ],
      countOfChildren: 4,
    ...
    },
    {
      ...
      name: "David Jones",
      families: [
        { _id: "f5", name: "Jones Family", memberCount: 2, createdAt: "2023-05-12" }
      ],
      countOfChildren: 1,
      ...
      name: "Eve Garcia",
      families: [
        { _id: "f6", name: "Garcia Family", memberCount: 4, createdAt: "2023-06-18" },
        { _id: "f8", name: "Miller Family", memberCount: 5, createdAt: "2023-07-20" }
      ],
      countOfChildren: 3,
      ...
      name: "Alice Miller",
      families: [
        { _id: "f7", name: "Miller Family", memberCount: 5, createdAt: "2023-07-20" }
      ],
      countOfChildren: 2,
